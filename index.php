    ...
    <div class="section" id="projects">
	    ...
	    <li><a href="https://git.watch/" target="_blank">Git Watch</a>, July 2016 to now.</li>
                ...
                <li><a target="_blank" href="https://github.com/ScalaWilliam/amazon-wishlist-api">Amazon Wishlist API
                        for Scala with Play and React</a>, since July 2013
                </li>
                <li><a target="_blank" href="https://github.com/ScalaWilliam/xs4s">XML Streaming for Scala (xs4s)</a>,
                    December 2013
                </li>
                <li><a target="_blank" href="https://github.com/ScalaWilliam/duel.gg">duel.gg</a>, open sourced since
                    August 2015
                </li>
                <li><a target="_blank" href="https://github.com/ScalaWilliam/scala-xml-printing">Scala XML Printing</a>,
                    December 2013
                </li>
    ...
    <aside id="links">
        ...
        <nav>
            <ul>
                ...
                <li id="li-github"><a href="https://github.com/ScalaWilliam/" target="_blank" title="GitHub link"
                        ><h3>GitHub</h3>

                        <p>See my code in open source projects..</p></a></li>
            </ul>
        </nav>
    </aside>
